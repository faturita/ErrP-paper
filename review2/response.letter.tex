...
\begin{quotation}
{\color{blue}
TODO: No entiendo esto bien a que se refiere
}
\end{quotation}
...
\begin{quotation}
{\color{blue}
Added information in the form of a footnote.
}
\end{quotation}
...
\begin{quotation}
{\color{blue}
AC'a hablar que es aceptable porqeu alcanza para aprender el optimal policy. Buscar una comparaci'on?
}
\end{quotation}
