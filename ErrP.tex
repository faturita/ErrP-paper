...
\begin{subfigure}{0.5\textwidth}
\centering
\includegraphics[scale=0.12]{revisedimages/matrix_1.eps}
\includegraphics[scale=0.12]{revisedimages/matrix_2.eps}\\
\includegraphics[scale=0.12]{revisedimages/matrix_3.eps}
\includegraphics[scale=0.12]{revisedimages/matrix_4.eps}\\
\includegraphics[scale=0.12]{revisedimages/matrix_5.eps}
\includegraphics[scale=0.12]{revisedimages/matrix_6.eps}\\
\includegraphics[scale=0.12]{revisedimages/matrix_7.eps}
\includegraphics[scale=0.12]{revisedimages/matrix_8.eps}\\
\end{subfigure}
