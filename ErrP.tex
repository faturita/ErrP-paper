...
Reinforcement Learning (RL) is an approach to machine learning where an agent tries to maximize the reward obtained while interacting with an unknown environment.  How much a gaming agent can be trained by the rewards obtained from human critics that watch their actions ?  This work implements a parsimonious application of this idea, to train an agent to solve a simple game using exclusively the information obtained from human critics that observe how to agent plays.
...
\end{subfigure}
\caption{ROC Curve for Subjects 5 and 6}
\end{figure}
...
\end{subfigure}
\caption{Confusion Matrix for subjects 1,3,4 and 8.}
